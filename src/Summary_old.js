...
const CenteredModal = (props) => {
    ...
    async function setupOciInfra() {
        setMsg("Setting up OCI resources. Please wait . . .")
        ...
        if (props.location.state.objStoreNameChecked) {
            ...
            formData.append("bucketname", props.location.state.sinkObjStore)
            formData.append("userocid", props.location.state.userocid)
    ...
    async function getStataData() {
        ...
        formData.append("compartmentID", compartmentID)
        //formData.append("compartmentID", "ocid1.compartment.oc1..aaaaaaaa77wkocg3az4cpp2rlxw63qilxrkva3nnsgrmczi5snmnjih2jszq");
        ...
        //consumeFormData.append("compartmentID", "ocid1.compartment.oc1..aaaaaaaa77wkocg3az4cpp2rlxw63qilxrkva3nnsgrmczi5snmnjih2jszq");
        ...
        await axios({
            url: `http://168.138.203.128:8082/consume/`,
            method: 'POST',

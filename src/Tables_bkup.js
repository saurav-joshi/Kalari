...
const Tables = (props) => {
    ...
    const handleClick = (e) => {
        ...
        axios({
            ...
            history.push({ pathname: "/showcolumns", state: { policy: props.location.state.policyName, parentSchema: props.location.state.parentSchema, pwd: props.location.state.pwd, childSchema: props.location.state.childSchema, tblName: tblName, colsData: ColsData } })
        }).catch(function (error) {

...
export const DataRedactionHome = (props) => {
    ...
    const handleNext = () => {
        ...
        axios({
            ...
            history.push({ pathname: "/showtables", state: { policy: policyName, parentSchema: parentSchema, pwd: password, childSchema: childSchema, tblData: tableData } })
                                    ...
                                    <Form.Group controlId="exampleForm.ControlTextarea1">
                                        <div style={{ display: 'flex', justifyContent: 'center' }}>
                                            <Col sm={5}>
                                                <br />
                                                <br />
                                                <Form.Label>Parent Schema <FilePersonFill /></Form.Label>
                                                ...
                                                <br />
                                                <br />
                                                <Form.Label>Child Schema <FilePersonFill /></Form.Label>
